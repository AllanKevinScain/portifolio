    ...
    >
      ...
      <div
        className={twMerge(
          ...
          "bg-[color-mix(in_srgb,var(--color-primary)_20%,transparent)] blur-[140px]",
        )}
      />
      ...
      <div className="relative flex flex-col items-center gap-6">
        <motion.div
          ...
          className={twMerge(
            "w-14 h-14",
            "rounded-full border-4 border-[color-mix(in_srgb,var(--color-primary)_30%,transparent)] border-t-(--color-primary)",
          )}
        />
